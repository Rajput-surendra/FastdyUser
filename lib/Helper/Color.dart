...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffbf2b92);
  static const Color secondary = Color(0xffbf2b92);
  ...
  static const Color grad1Color = Color(0xffbf2b92);
  static const Color grad2Color = Color(0xffbf2b92);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xffbf2b92);

  static const Color red = Color(0xffbf2b92);
