...
final String packageName = 'com.fastdy.user';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'com.fastdy.user';
final String iosLink = 'your ios link here';
final String appStoreId = 'com.fastdy.user';
...
final String baseUrl = 'https://fastdy.in/app/v1/api/';
